...
import {Back, Car, Driveeer, Uper} from '../assets/Images/SVGs/Continue';
import Main from '../assets/Images/PNG/Logo.png';
import {
  Driveeeeeeeeeeeer,
  Termstext,
  Transporter,
} from './Components/Policytext';
import CheckBox from '@react-native-community/checkbox';
const Driveee = ({navigation}) => {
    ...
    <View style={styles.Container}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={styles.TextContainer}>
          <Text style={styles.Title}>Allmänna villkor för Förare</Text>
        </View>
