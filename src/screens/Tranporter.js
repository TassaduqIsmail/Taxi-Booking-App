...
import {Back, Car, Uper} from '../assets/Images/SVGs/Continue';
import Main from '../assets/Images/PNG/Logo.png';
import {Termstext, Transporter} from './Components/Policytext';
import CheckBox from '@react-native-community/checkbox';
const Tranporter = ({navigation}) => {
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={styles.TextContainer}>
          <Text style={styles.Title}>
            Användarvillkor Blink-appen – Transportör
          </Text>
        </View>
