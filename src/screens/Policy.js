  ...
  return (
    <View style={styles.Container}>
      ...
      <ScrollView ref={scrollViewRef}>
        <Text style={styles.Title}>Integritets Policy</Text>
        <Image source={Main} resizeMode="contain" style={styles.img} />
        <View style={styles.TextContainer}>
          <Text style={styles.InnerPolicy}>
            Blink AB är registeransvarig för dina personuppgifter om inget annat
            anges nedan. Vår adress är: Gottstavägen 91. 76343 Hallstavik.
            Reg.nr 559329-2880
          </Text>
        </View>
